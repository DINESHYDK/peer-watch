        ...
        <div className="bg-card rounded-card shadow-float-lg p-8">
          ...
          {magicSent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <p className="text-xs text-red-500 font-medium bg-red-50 rounded-pill px-3 py-2 animate-fade-in">
                  {error}
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-violet-gradient text-white font-bold rounded-pill py-3 text-sm transition-all duration-200 hover:shadow-glow hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                id="auth-submit"
              >
                {loading ? (
              ...
              <div className="flex items-center gap-2 my-2">
                <div className="flex-1 h-px bg-bg-dark" />
              ...
              <button
                ...
                disabled={loading}
                className="w-full border-2 border-bg-dark text-text-muted font-semibold rounded-pill py-2.5 text-sm hover:border-accent-violet hover:text-accent-violet transition-all duration-200"
                id="magic-link-btn"
              >
                ✨ Send Magic Link
              </button>
